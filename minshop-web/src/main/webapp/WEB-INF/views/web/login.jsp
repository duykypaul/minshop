			...
			<div id="container-login-right">
				...
				<div id="middle-right">
					<div id="middle-right" class="form-login">
						...
						<input id="password" class="input-icon-password" type="password" placeholder="Mật khẩu" name="password">
					...
					<span id="status_login" class="wow bounceOutUp">${status_login}</span>
				</div>
				<div id="footer-right">
